...
Private Sub cmdSend_Click()
  If rtfSend.Text <> "" And frmSignOn.wskAIM.state = sckConnected Then
    Call SendProc(2, "toc_send_im " & Me.Tag & " " & Chr(34) & Normalize("<HTML>" & rtfSend.Text & "</HTML>") & Chr(34) & Chr(0))
        Call RTFUpdate(rtfDisplay, htmltorich2("<font color=""#0000FF"" size=3>" + m_strFormattedSN$ + " </font><font color=""#000000"" size=3 face=""times new roman""></p>" + rtfSend.Text))
    rtfSend.Text = ""
...
Private Sub Command1_Click()
        ...
        frmInfo.Show
        km = InStr(1, Me.Caption, "-")
        
        
        If km <> 0 Then
        frmInfo.WhoInfo.Text = Left$(Me.Caption, km - 1)
        Else
